...
public class OperationServiceImpl implements OperationService {
    ...
    @Override
    public List<Operation> getOperationsByFamemsAndCategories(List<Long> familyMembersId, List<Long> categoryIdList, LocalDate startDate, LocalDate endDate) {
        ...
        return operationRepositoryCustom.findAllExpensesByPredicates(familyMembers, categoryList, startDate, endDate);
    }
}