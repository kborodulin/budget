...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h3 class="h3">Данные семьи
        <input type="text" class="form-control set-control-family" id="FamilyName" placeholder="Family" value="" required="">
    </h3>
    <a class="d-flex align-items-center text-muted" href="#" style= "display:none">
        <span id="edition-family" style="text-decoration: underline; display:inherit;">редактирование&nbsp;</span>
