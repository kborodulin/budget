...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form:form id= "addIncome" class="form-inline" name="expensesForm" action="/account/expenses/newExpenses">
            ...
            <table class="table my-5">
                ...
                <c:forEach items="${allExpensesUser}" var="expense">
                    <tr>
                        ...
                        <td>
                            <a href="/income/find/${expense.operationid}">Изменить</a>
                        </td>
                        <td>
                            <a href="/income/delete/${expense.operationid}">Удалить</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
