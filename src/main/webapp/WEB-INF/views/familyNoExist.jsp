...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <a class="d-flex align-items-center text-muted" href="#" style= "display:none">
        <span id="edition-new-family" style="text-decoration: underline; display:inherit;">создать семью&nbsp;</span>
        <span id="save-item-new-family" style="text-decoration: underline; display:none;">сохранить семью&nbsp;</span>
    </a>
</div>
    <div>
